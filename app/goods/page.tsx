...
const ASSETS = [
  ...
  { id: 'hikakin', name: 'HIKAKIN', path: '/images/HIKAKIN.webp' },
  { id: 'himawari', name: 'HIMAWARIちゃんねる', path: '/images/himawari.webp' },
  { id: 'mcf2026', name: 'MCF2026', path: '/images/MCF2026.webp' },
  { id: 'mrs_green_apple', name: 'Mrs.GREEN APPLE', path: '/images/Mrs.GREEN APPLE.webp' },
  { id: 'yss', name: 'YSS', path: '/images/YSS.webp' },
  { id: 'chumusan', name: 'ちゅむさん', path: '/images/chumusan.webp' },
  { id: 'grampus', name: 'グランパス', path: '/images/grampus.webp' },
  { id: 'doara', name: 'ドアラ', path: '/images/doara.webp' },
  { id: 'dragons_slogan', name: 'ドラゴンズ Slogan', path: '/images/dragons_slogan.webp' },
  { id: 'dragons_logo', name: 'ドラゴンズ Logo', path: '/images/dragons_logo.webp' },
  { id: 'ohno_memorial', name: '大野 雄大 Memorial', path: '/images/ohno_memorial.webp' },
  { id: 'hiejima_makoto', name: '比江島 慎', path: '/images/hiejima_makoto.webp' },
  { id: 'fukunaga_hiroki', name: '福永 裕基', path: '/images/fukunaga_hiroki.webp' },
  { id: 'inagaki_sho', name: '稲垣 祥', path: '/images/inagaki_sho.webp' },
  { id: 'hiroto_takahashi_img', name: '髙橋 宏人', path: '/images/hiroto_takahashi_img.webp' },
];
